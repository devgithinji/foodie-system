...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3372407522113989356L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"org.densoft.foodie.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static org.densoft.foodie.kafka.order.avro.model.Product.Builder newBuilder() {
    return new org.densoft.foodie.kafka.order.avro.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.Product.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.Product.Builder other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.Product.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.Product.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.Product other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.Product.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
