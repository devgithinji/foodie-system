...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder() {
    return new org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
