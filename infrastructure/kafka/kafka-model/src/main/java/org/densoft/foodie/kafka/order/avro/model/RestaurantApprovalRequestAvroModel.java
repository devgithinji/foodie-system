...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -433437265658388976L;
  ...
  private org.densoft.foodie.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus;
  private java.util.List<org.densoft.foodie.kafka.order.avro.model.Product> products;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: restaurantOrderStatus = (org.densoft.foodie.kafka.order.avro.model.RestaurantOrderStatus)value$; break;
    case 5: products = (java.util.List<org.densoft.foodie.kafka.order.avro.model.Product>)value$; break;
   ...
   */
  public static org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder() {
    return new org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel other) {
    if (other == null) {
      return new org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.densoft.foodie.kafka.order.avro.model.RestaurantApprovalRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus : (org.densoft.foodie.kafka.order.avro.model.RestaurantOrderStatus) defaultValue(fields()[4]);
        record.products = fieldSetFlags()[5] ? this.products : (java.util.List<org.densoft.foodie.kafka.order.avro.model.Product>) defaultValue(fields()[5]);
