package org.densoft.foodie.restaurant.service.messaging.publisher.kafka;
...
import org.densoft.foodie.restaurant.service.domain.config.RestaurantServiceConfigData;
import org.densoft.foodie.restaurant.service.domain.ports.ouput.message.publisher.OrderApprovedMessagePublisher;
import org.densoft.foodie.restaurant.service.messaging.mapper.RestaurantMessagingDataMapper;
...
public class OrderApprovedKafkaMessagePublisher implements OrderApprovedMessagePublisher {
    ...
    public void publish(OrderApprovedEvent orderApprovedEvent) {
        ...
        log.info("Received OrderAprovalEvent for order id: {}", orderId);

        try {
            RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel = restaurantMessagingDataMapper.orderApprovedEventToRestaurantApprovalResponseAvroModel(orderApprovedEvent);
